package hr.tvz.milakovic.hardwareapp.security;

import hr.tvz.milakovic.hardwareapp.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private boolean isEndpointAllowingUnauthenticatedAccess(HttpServletRequest request) {
        ...
        return hr.tvz.milakovic.hardwareapp.security.SecurityConfiguration.UNAUTHENTICATED_ENDPOINTS
                .stream()
